## [译] 如何在 JavaScript 中使用 apply(💅),call(📞),bind(➰)函数
...
因此，想要掌握本文所述内容，您必须熟悉 `this` 关键字的概念和用法。可以参考[这篇文章](https://medium.freecodecamp.org/a-guide-to-this-in-javascript-e3b9daef4df1)。
